...
//  MyCar
//
//  Created by Aksilont on 26.05.2022.
//
...
extension CGPoint {
    ...
    func point(to: CGPoint, t: CGFloat, control1: CGPoint, control2: CGPoint) -> CGPoint {
        let x = CGPoint.value(x: x, y: to.x, t: t, c1: control1.x, c2: control2.x)
        let y = CGPoint.value(x: y, y: to.y, t: t, c1: control1.y, c2: control2.x)
